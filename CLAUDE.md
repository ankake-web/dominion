...
- **2026-08-21 時点＝17拡張＋プロモ＝全811枚（縦型585＋横型226）が実プレイ可能**
  ...
  ⚠ **絵が入っていないのは旭日の50枚だけ**（枠＋文字。他の761枚は絵入り）＝**次にやるのは絵の回収**。
  旭日は完成＝段階0〜段階2 R7。正本 `docs/research/risingsun_rules.md`（847KB）。
  ⚠ 旭日の後に**第17拡張 Arcana**（2026年予定）があるが、**カード名すら未公開なので現時点では着手不能**。
