...
const ZONES = ['deck', 'hand', 'discard', 'inPlay', 'durationCards', 'setAside', 'islandMat', 'nativeVillageMat',
  ...
  'puzzleBox', // 略奪：パズルボックスの脇札（裏向き＝所有者のみ可視だが物理カード。ターン終了時に手札へ戻る）
  'foresightAside', // 旭日：洞察の脇札（公開・物理カード。ターン終了時に手札へ戻る）
  'bidingAside', // 旭日：好機到来の脇札（裏向き＝所有者のみ可視だが物理カード。次の自分のターン開始時に手札へ戻る）
  'cage',      // 略奪：檻の脇札（裏向き＝所有者のみ可視だが物理カード。勝利点を獲得したターンの終了時に手札へ戻る）
  'deliverAside', 'prepareAside']; // 略奪：配達/準備（イベント）の脇札（公開・物理カード）
