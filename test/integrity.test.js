...
console.log('=== 資本主義：財宝になるアクションの集合が固定されている ===');
{
  ...
  ok(set.length === 140, '資本主義で財宝になるアクションは140枚（カタログ文を変えたらこの数を見直す。実: ' + set.length + '）');
}
