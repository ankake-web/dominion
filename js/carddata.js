...
(function () {
  ...
  const EMBEDDED = [
    ...
    { id: 'militia', name: '民兵', cost: 4, type: 'attack', typeLabel: 'アクション / Action', art: 'assets/art/militia.jpg', icon: '⚔️', effects: ['+2 コイン', '他は手札3枚まで捨てる'] },
    { id: 'mine', name: '鉱山', cost: 5, type: 'action', typeLabel: 'アクション / Action', art: 'assets/art/mine.jpg', icon: '⛏️', effects: ['財宝1枚を廃棄', 'コスト+3以下の財宝を獲得'] },
    { id: 'moat', name: '堀', cost: 2, type: 'reaction', typeLabel: 'アクション / Action', art: 'assets/art/moat.jpg', icon: '🛡️', effects: ['+2 カード', 'アタックを無効化できる'] },
