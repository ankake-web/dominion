...
(function () {
  ...
  DOM.CARDS = {
    ...
    hoard:        { id: 'hoard',        name: '隠し財産',   cost: 6, types: ['treasure'], coin: 2,
                    text: 'コイン +2\nこのターン、勝利点カードを獲得したとき、それを購入していたなら、金貨1枚を獲得する。' },
    ...
    oracle: { id: 'oracle', name: '神託', cost: 3, types: ['action', 'attack'],
                 text: '各プレイヤー（あなたを含む）は自分の山札の上から2枚を公開する。あなたはプレイヤーごとに、それらを捨て札にさせるか、山札の一番上に戻させるかを選ぶ（戻す順番はそのプレイヤーが決める）。\nその後、+2 カード' },
    ...
    haggler: { id: 'haggler', name: '値切り屋', cost: 5, types: ['action'],
                 text: '+2 コイン\nこのターン、カードを獲得したとき、それを購入していたなら、そのコスト未満の勝利点でないカード1枚を獲得する。' },
    highway: { id: 'highway', name: '街道', cost: 5, types: ['action'],
                 text: '+1 カード\n+1 アクション\nこのターン、すべてのカードのコストは 1 コイン安くなる。' },
    ...
    farmland: { id: 'farmland', name: '農地', cost: 6, types: ['victory'], vp: 2,
                 text: '2 勝利点\n————\nこれを獲得したとき、手札のカード1枚を廃棄し、そのコストよりちょうど 2 コイン高い、農地でないカード1枚を獲得する。' },
    ...
    port: { id: 'port', name: '港町', cost: 4, types: ['action'],
                 text: '+1 カード\n+2 アクション\n————\nこれを獲得したとき、もう1枚の港町を獲得する（この2枚目ではさらに獲得しない）。' },
    ...
    chariot_race: { id: 'chariot_race', name: '戦車競走', cost: 3, types: ['action'],
                 text: '+1 アクション\n+1 カード（引いたカードを公開する）。左隣のプレイヤーは自分の山札の一番上を公開する。\nあなたのカードのコストが高ければ、+1 コイン と 勝利点トークン1個。' },
