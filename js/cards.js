...
(function () {
  ...
  DOM.CARDS = {
    ...
    hermit: { id: 'hermit', name: '隠遁者', cost: 3, types: ['action'],
                 text: '捨て札置き場を見る。そこか手札から財宝以外のカード1枚を廃棄してよい。\nコスト3以下のカードを1枚獲得する。\nこれを場から捨てるとき、このターンにカードを購入していなければ、これを廃棄して狂人1枚を獲得する。' },
    ...
    procession: { id: 'procession', name: '行進', cost: 4, types: ['action'],
                 text: '手札のアクションカード1枚を2回プレイしてよい。\nその後それを廃棄し、それよりコストがちょうど1多いアクションカード1枚を獲得する。' },
    ...
    death_cart: { id: 'death_cart', name: '死の荷車', cost: 4, types: ['action'],
                 text: '手札のアクションカードか死の荷車1枚を廃棄して +5 コイン（廃棄しないならこれを廃棄する）。\nこれを獲得したとき、廃墟2枚を獲得する。' },
    marauder: { id: 'marauder', name: '略奪者', cost: 4, types: ['action', 'attack'],
